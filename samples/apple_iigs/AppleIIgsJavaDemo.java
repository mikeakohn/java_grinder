...
public class AppleIIgsJavaDemo
{
  ...
  static byte new_wave[] =
  {
    ...
    -79, -77, -76, -75, -74, -72, -71, -70, 
    -69, -67, -66, -65, -64, -63, -61, -60, 
    -59, -58, -56, -55, -54, -53, -51, -50, 
    -49, -48, -46, -45, -44, -43, -41, -40, 
    -39, -38, -36, -35, -34, -33, -31, -30, 
    -29, -28, -26, -25, -24, -23, -21, -20, 
    ...
    119, 119, 120, 120, 121, 122, 122, 123, 
...
108, 115, 121, 129, 136, 144, 153, 162, 171, 181, 192, 204, 216, 228, 242, 256, 271, 287, 304, 322, 341, 362, 383, 405, 429, 455, 482, 510, 540, 572, 606, 642, 680, 720, 762, 807, 855, 905, 959, 1015, 1075, 1139, 1206, 1277, 1353, 1432, 1517, 1607, 1701,
  ...
  public static void main()
  {
    ...
    // play a scale
    AppleIIgs.loadWaveTable(new_wave, 0);
    AppleIIgs.loadWaveTable(new_wave, 1);
    AppleIIgs.enableOscillators(16);
    AppleIIgs.setMasterVolume(15);
    AppleIIgs.setWaveTable(0, 1, 2);
    AppleIIgs.setSoundVolume(0, 255);
    AppleIIgs.setWaveTable(1, 1, 2);
