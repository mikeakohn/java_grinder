...
struct table_java_instr_t table_java_instr[] =
{
  ...
  { "ifeq", 3, 0, OP_TYPE_UNKNOWN }, // ifeq (0x99)
  { "ifne", 3, 0, OP_TYPE_UNKNOWN }, // ifne (0x9a)
  { "iflt", 3, 0, OP_TYPE_UNKNOWN }, // iflt (0x9b)
  { "ifge", 3, 0, OP_TYPE_UNKNOWN }, // ifge (0x9c)
  { "ifgt", 3, 0, OP_TYPE_UNKNOWN }, // ifgt (0x9d)
  { "ifle", 3, 0, OP_TYPE_UNKNOWN }, // ifle (0x9e)
  { "if_icmpeq", 3, 0, OP_TYPE_UNKNOWN }, // if_icmpeq (0x9f)
  { "if_icmpne", 3, 0, OP_TYPE_UNKNOWN }, // if_icmpne (0xa0)
  { "if_icmplt", 3, 0, OP_TYPE_UNKNOWN }, // if_icmplt (0xa1)
  { "if_icmpge", 3, 0, OP_TYPE_UNKNOWN }, // if_icmpge (0xa2)
  { "if_icmpgt", 3, 0, OP_TYPE_UNKNOWN }, // if_icmpgt (0xa3)
  { "if_icmple", 3, 0, OP_TYPE_UNKNOWN }, // if_icmple (0xa4)
  { "if_acmpeq", 1, 0, OP_TYPE_UNKNOWN }, // if_acmpeq (0xa5)
  { "if_acmpne", 1, 0, OP_TYPE_UNKNOWN }, // if_acmpne (0xa6)
