...
int blitter(JavaClass *java_class, Generator *generator, const char *method_name)
{
  ...
  CHECK_FUNC_BLITTER(setSourceA,_I)
  CHECK_FUNC_BLITTER(setSourceB,_I)
  CHECK_FUNC_BLITTER(setSourceC,_I)
  CHECK_FUNC_BLITTER(setDestination,_I)
  ...
  CHECK_FUNC_BLITTER(setDataRegisterA,_C)
  CHECK_FUNC_BLITTER(setDataRegisterB,_C)
  CHECK_FUNC_BLITTER(setDataRegisterC,_C)
