...
int sega_genesis(JavaClass *java_class, Generator *generator, char *method_name)
{
  ...
  CHECK_FUNC(setSpriteStretchSize,_III)
  CHECK_FUNC(setSpritePattern,_II)
  CHECK_FUNC(setSpriteFlipHorizontal,_IB)
  CHECK_FUNC(setSpriteFlipVertical,_IB)
  CHECK_FUNC(setSpritePriority,_IB)
  CHECK_FUNC(setSpriteLinkField,_II)
